...
@Component({
  selector: 'app-input-form-clone',
  templateUrl: './input-form-clone.component.html',
  styleUrls: ['./input-form-clone.component.scss'],
})
export class InputFormCloneComponent implements OnInit {
  ...
  submitClone() {
    console.log(this.reportTemplateID);
